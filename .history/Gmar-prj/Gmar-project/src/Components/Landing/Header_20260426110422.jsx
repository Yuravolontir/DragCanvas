...
const handlePublish = async () => {
  ...
  Domain (optional)</label>
        ...
        <p style={{ fontSize: '0.8rem', color: '#9994a0', marginBottom: '20px' }}>
          Buy a domain on <a href='https://www.namecheap.com/?gad_source=1&gad_campaignid=11301910042&gbraid=0AAAAADzFe23iAppO8kCg777_h9HuH9zkt&gclid=Cj0KCQjw77bPBhC_ARIsAGAjjV9YzqNX49sV8slD6thUWuiZ7fuCt17aivswn0eV77DDFrc7GpRWpu8aAi1PEALw_wcB'>Namecheap</a> or GoDaddy, then enter it here
        </p>
