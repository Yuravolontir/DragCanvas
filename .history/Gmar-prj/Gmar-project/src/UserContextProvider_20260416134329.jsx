...
export default function UserContextProvider(props) {
  ...
  const login = async (email, password) => {
    ...
    try {
      ...
      setCurrentUser(data2.user);
      setIsAdmin(data2.admin);
      setIsSuperAdmin(data2.user.IsSuperAdmin);
      localStorage.setItem('currentUser', JSON.stringify(data2.user));
      localStorage.setItem('isAdmin', JSON.stringify(data2.admin));
      localStorage.setItem('isSuperAdmin', JSON.stringify(data2.user.IsSuperAdmin));
