  ...
  handleKeyDown);
      }, [currentIndex, filteredTemplates.length]); // Added currentIndex
  ...
  style={{
                  ...
                  {currentTemplate?.ThumbnailURL ? (
                    ...
                    <div
                      className="text-center text-muted d-flex
  ...
  me-2">{currentTemplate?.Category}</span>
                        <small className="text-muted">
                          {currentTemplate?.ComponentCount} components •
                          by {currentTemplate?.CreatedByName}
                        </small>
                      </div>
                      <Button
                        variant="primary"
