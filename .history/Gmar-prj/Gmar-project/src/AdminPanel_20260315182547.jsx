...
export default function AdminPanel() {
  ...
  setShowDeleteModal(false)} centered>
          <Modal.Header closeButton>
            <Modal.Title>⚠️ Confirm Permanent
  Deletion</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>Are you sure you want to permanently delete
  <strong>{userToDelete?.UserName}</strong>?</p>
            <p className="text-muted">Email:
  {userToDelete?.UserEmail}</p>
            <p className="text-danger mt-3">
              <strong>⚠️ Warning:</strong> This action cannot be
  undone!
            </p>
            {deleteResult && (
              <div className={`alert ${deleteResult.success ?
