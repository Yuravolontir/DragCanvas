...
Generate a valid Craft.js serialized node tree.
...

{
  "ROOT_NODE_ID": {
    ...
    "isCanvas": true,
    "props": { "width": "100%", "flexDirection": "column", "padding": ["40","40","40","40"] },
  ...
  "NODE_ID_1": {
    ...
    "isCanvas": false,
    "props": { "text": "Hello world", "fontSize": "48" },
    "displayName": "Text",
    "custom": {},
    "hidden": false,
    "nodes": []
...
Each section can contain Text, Button, Image, Video, or Link.
`
        },
        {
          role: 'user',
