...
Do not use markdown in any text.

Use ONLY these URLs as plain strings:
...
IMPORTANT:
- text elements must use props.text (NOT children)
- image elements must use props.src
- video elements must use props.embedUrl
- Keep props simple: width, flexDirection, padding (array of 4 strings), background, text, fontSize, fontWeight, textAlign, color, src, embedUrl, href.
`.trim();
