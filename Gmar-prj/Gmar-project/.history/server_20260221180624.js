...
//=================================
 ...
 app.post('/api/ai-generate', async (req, res) => {
  ...
  Generate ONLY raw JSON for a website
  layout.
  ...
  - All image URLs must be real URLs
  starting with https:// (use:
  https://images.unsplash.com or
  ...
  Available types: container, text,
  button, image, video, link
  Create 2-4 sections with nested
  children as needed.
  `
