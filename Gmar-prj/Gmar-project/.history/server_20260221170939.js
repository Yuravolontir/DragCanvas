...
//=================================
 // Add this after your existing endpoints (after the register endpoint)
    ...
    try {
      ...
      const requestData = {
        ...
        messages: [
          {
            role: 'system',
            content: `You are a web
  builder AI. Generate JSON layout using
  available elements: Container, Text,
  Button, Video, Image, Link.

  Return ONLY raw JSON in this exact
  format (no markdown, no code blocks):
  {
    "sections": [
      {
        "type": "container",
  ...
  Generate 2-4 sections based on the
  request.`
          },
          {
            role: 'user',
