...
app.post('/api/ai-generate', async (req, res) => {
  try {
   ...
   JSON. No markdown. Start with {"sections":[ and end with }]}.

  CRITICAL: Use videoUrl for direct video files. NEVER use videoId.

  VIDEO URLS (copy exactly these):
  ...
  2918-large.mp4
  https://assets.mixkit.co/videos/preview/mixkit-cooking-meat-in-a-frying-pan-larg
  e.mp4
  ...
  COMPLETE VIDEO HERO EXAMPLE (copy this pattern):
  {"type":"container","props":{"width":"100%","position":"relative","minHeight":"7
  00","overflow":"hidden","background":"#0a0a0a"},"children":[{"type":"video","pro
  ps":{"videoUrl":"https://assets.mixkit.co/videos/preview/mixkit-stars-in-space-b
  ackground-1612-large.mp4","width":"100%","height":"100%","position":"absolute","
  top":"0","left":"0","zIndex":"0"}},{"type":"container","props":{"position":"abso
  lute","top":"0","left":"0","right":"0","bottom":"0","zIndex":"1","display":"flex
  ","flexDirection":"column","justifyContent":"center","alignItems":"center","padd
  ing":["80","60","80","60"],"background":"linear-gradient(to bottom,rgba(10,10,10
  ,0.8),rgba(20,20,20,0.6))"},"children":[{"type":"text","props":{"text":"Your
  Main Headline Goes Here","fontSize":"72","fontWeight":"bold","color":"#ffffff","
  textAlign":"center"}},{"type":"text","props":{"text":"Your compelling subtitle
  description
  here","fontSize":"24","color":"rgba(255,255,255,0.9)","textAlign":"center","marg
  inTop":"20","maxWidth":"700"}},{"type":"button","props":{"text":"Call to
  Action","background":"#667eea","color":"#ffffff","padding":["20","48"],"borderRa
  dius":"60","fontSize":"18","fontWeight":"600","marginTop":"40"}}]}]}

  MUST-FOLLOW PATTERNS:
  1. Video first: {"type":"video","props":{"videoUrl":"[COPY_ONE_OF_THE_MIXKIT_URL
  S_ABOVE]","position":"absolute","top":"0","left":"0","zIndex":"0","width":"100%"
  ,"height":"100%"}}
  2. Overlay second: {"type":"container","props":{"position":"absolute","top":"0",
  "left":"0","right":"0","bottom":"0","zIndex":"1","display":"flex","justifyConten
  t":"center","alignItems":"center","background":"rgba(0,0,0,0.5)"}}
  3. Always use videoUrl NEVER videoId
  4. Match video to topic (cooking→food video, fitness→exercise video, etc)

  Generate 6 sections total. Use gradients, shadows, and modern styling. End with
  }]}]}`;
      const requestData = {
        model: 'sonar-pro',
        messages: [
