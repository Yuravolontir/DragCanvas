...
if (!projectName) {
  ...
  {!projectName && (
    ...
    console.log('[data-craft]:', document.querySelector('[data-craft]'));
    console.log('[data-craft="frame"]:', document.querySelector('[data-craft="frame"]'));
    console.log('[data-craft-node] elements:',
  document.querySelectorAll('[data-craft-node]').length);
    console.log('[data-craft-node] ROOT:',
  document.querySelector('[data-craft-node="ROOT"]'));

    // Check the whole body
    console.log('Body children:', document.body.children.length);
    Array.from(document.body.children).forEach((child, i) => {
      console.log(`Child ${i}:`, child.className, child.id, child.tagName);
    });
  }}>
              <Checkmark viewBox="-3 -3 20 20" />
              Get HTML
