...
const deployToNetlify = async () => {
    ...
    if (!accessToken) {
      const userToken = prompt('Enter your Netlify Personal Access Token:');
      if (userToken) {
        localStorage.setItem('netlify_token', userToken);
        deployToNetlify(contentDiv.outerHTML, userToken);
      }
    } else {
      deployToNetlify(contentDiv.outerHTML, token);
    }
  }
...
<Btn   className="ml-2 bg-blue-500" onClick={deployToNetlify}>
           Netlify
            <input
    type="text"
