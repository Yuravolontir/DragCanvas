...
`;
  ...
  ${clone.outerHTML}
    ...
    try {
      ...
      if (!userResponse.ok) {
        throw new Error('Invalid token. Check your Netlify Personal Access Token.');
      }
      ...
      // Upload the HTML file using the correct endpoint
      const uploadUrl = `https://api.netlify.com/api/v1/sites/${site.id}/files/index.html`;
