...
if (!projectName) {
  ...
  {!projectName && (
    ...
    console.log('Renderer innerHTML:', renderer?.innerHTML.substring(0, 1000));
    console.log('Renderer children:', renderer?.children.length);
    console.log('First child HTML:', renderer?.firstElementChild?.innerHTML.substring(0,
  500));
  }}>
              <Checkmark viewBox="-3 -3 20 20" />
              Get HTML
